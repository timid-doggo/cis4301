			...
			@ini_set('display_errors', 0);
				...
				if($first == 'amount')
				{
					...
					else if($second == 'makemore')
					{
						...
						$line = 'The amount of cocaine users that make more than $50,000: ';
					}
					else if($second == 'makeless')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND consumes.person = People.ID
						  		AND has.person = People.ID";
						$line = 'The amount of cocaine users that make less than $50,000: ';
					}
				...
				else if($first == 'percentage')
				{
					...
					{
						$s = "SELECT cast(round(((count(*)*100)/6630),2) AS DECIMAL(5,2))
									FROM people, consumes, has
									WHERE consumes.drug = 'Cocaine'
									AND consumes.person= people.id
									AND people.id=has.person
									AND has.income >50000";
									$line = 'The percentage of people who use cocaine and make more than $50,000: ';
					}
					else if($second == 'makeless')
					{
						$s = "SELECT cast(round(((count(*)*100)/6630),2) AS DECIMAL(5,2))
									...
									AND people.id=has.person
									AND has.income <50000";
									$line = 'The percentage of people who use cocaine and make less than $50,000: ';
					}
					else if($second == 'unemployed')
					{
						$s = "SELECT cast(round(((count(*)*100)/6630),2) as decimal(5,2))
