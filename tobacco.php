      ...
      What would you like to know about Tobacco users?
		...
		<p>
			<form method="post">
				...
				of Tobacco users who work in the field of
			...
			@ini_set('display_errors', 0);
				...
				if($first == 'amount')
				{
					if(empty($second))
					{
						...
						$line = 'The amount of tobacco users is: ';
					}
					else if($second == 'makemore')
					{
						...
						$line = 'The amount of tobacco users that make more than $50,000: ';
					}
					else if($second == 'makeless')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND consumes.person = People.ID
						  		AND has.person = People.ID";
						$line = 'The amount of tobacco users that make less than $50,000: ';
					}
					else if($second == 'unemployed')
					{
						...
						$line = 'The amount of tobacco users that are unemployed: ';
					}
					else if($second == 'employed')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND has.person=consumes.person
						  		AND consumes.drug='Cigarette'";
						$line = 'The amount of tobacco users that are employed: ';
					}
					else if($second == 'nhw')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND consumes.drug='Cigarette'";
						$line = 'The amount of tobacco users that are Non-Hispanic White: ';
					}
					else if($second == 'hispanic')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
						$line = 'The amount of tobacco users that are Hispanic: ';
					}
					else if($second == 'nhb')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
									$line = 'The amount of tobacco users that are Non-Hispanic Black: ';
					}
					else if($second == 'nhpi')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
									$line = 'The amount of tobacco users that are Non-Hispanic Pacific Islander: ';
					}
					else if($second == 'nhm')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
									$line = 'The amount of tobacco users that are Non-Hispanic multiracial: ';
					}
					else if($second == 'nha')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
									$line = 'The amount of tobacco users that are Non-Hispanic Asian: ';
					}
					else if($second == 'nhna')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
									$line = 'The amount of tobacco users that are Non-Hispanic Native-American: ';
								}
				}
				else if($first == 'percentage')
				{
					if(empty($second))
					{
						...
						$line = 'The percentage of people who use tobacco: ';
					}
					else if($second == 'makemore')
					{
						$s = "SELECT cast(round(((count(*)*100)/29212),2) AS DECIMAL(5,2))
									...
									AND has.income >50000";
									$line = 'The percentage of people who use tobacco and make more than $50,000: ';
					}
					else if($second == 'makeless')
					{
						$s = "SELECT cast(round(((count(*)*100)/29212),2) AS DECIMAL(5,2))
									...
									AND people.id=has.person
									AND has.income <50000";
									$line = 'The percentage of people who use tobacco and make less than $50,000: ';
					}
					else if($second == 'unemployed')
					{
						$s = "SELECT cast(round(((count(*)*100)/29212),2) as decimal(5,2))
  								...
  								AND has.person=consumes.person
  								AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are unemployed: ';
					}
					else if($second == 'employed')
					{
						$s = "SELECT cast(round(((count(*)*100)/29212),2) as decimal(5,2))
  								...
  								AND has.person=consumes.person
  								AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are employed: ';
					}
					else if($second == 'nhw')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are Non-Hispanic White: ';
					}
					else if($second == 'hispanic')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
								  ...
								  AND people.id=consumes.person
								  AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are Hispanic: ';
					}
					else if($second == 'nhb')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
								  ...
								  AND people.id=consumes.person
								  AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are Non-Hispanic Black: ';
					}
					else if($second == 'nhpi')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
					...
					else if($second == 'nhm')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
									...
									AND people.id=consumes.person
									AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are Non-Hispanic multiracial: ';
					}
					else if($second == 'nha')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
					...
					else if($second == 'nhna')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/29212),2) AS DECIMAL(5,2))
								  ...
								  AND people.id=consumes.person
								  AND consumes.drug='Cigarette'";
									$line = 'The percentage of people who use tobacco and are Non-Hispanic Native-American: ';
					}
				}
				else{
					if(!empty($S2) && empty($S3)){
						$line="The {$S1} {$S2} of tobacco users: ";
					}
					else if(!empty($S2)){
						...
						$line="The {$S1} {$S2} of tobacco users who work in the field of {$job} : ";
					}
					if($S1 == 'average')
					{
						if($S2 == 'age')
