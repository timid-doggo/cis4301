...
<html>
	...
	<body>
		<div id="content">
  	<h1>2014 NSDUH Statistics on Marijuana</h1>
    <h3>
      What would you like to know about Marijuana users?
    </h3>
    	<p>
    		<form method="post">
		...
		<p>
			<form method="post">
				...
				of Marijuana users who work in the field of
			...
			@ini_set('display_errors', 0);
				...
				if($first == 'amount')
				{
					if(empty($second))
					{
						$s = "SELECT COUNT(*)
									FROM consumes
									WHERE drug = 'Marijuana'";
						$line = 'The amount of marijuana users is: ';
					}
					...
					else if($second == 'unemployed')
					{
						...
						$line = 'The amount of marijuana users that are unemployed: ';
					}
					else if($second == 'employed')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND has.person=consumes.person
						  		AND consumes.drug='Marijuana'";
						$line = 'The amount of marijuana users that are employed: ';
					}
					else if($second == 'nhw')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND consumes.drug='Marijuana'";
						$line = 'The amount of marijuana users that are Non-Hispanic White: ';
					}
					else if($second == 'hispanic')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
						$line = 'The amount of marijuana users that are Hispanic: ';
					}
					else if($second == 'nhb')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
									$line = 'The amount of marijuana users that are Non-Hispanic Black: ';
					}
					else if($second == 'nhpi')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
									$line = 'The amount of marijuana users that are Non-Hispanic Pacific Islander: ';
					}
					else if($second == 'nhm')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
									$line = 'The amount of marijuana users that are Non-Hispanic multiracial: ';
					}
					else if($second == 'nha')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
									$line = 'The amount of marijuana users that are Non-Hispanic Asian: ';
					}
					else if($second == 'nhna')
					{
						$s = "SELECT COUNT(*)
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
									$line = 'The amount of marijuana users that are Non-Hispanic Native-American: ';
								}
				}
				else if($first == 'percentage')
				{
					...
					else if($second == 'unemployed')
					{
						$s = "SELECT cast(round(((count(*)*100)/55270),2) as decimal(5,2))
  								...
  								AND has.person=consumes.person
  								AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are unemployed: ';
					}
					else if($second == 'employed')
					{
						$s = "SELECT cast(round(((count(*)*100)/55270),2) as decimal(5,2))
  								...
  								AND has.person=consumes.person
  								AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are employed: ';
					}
					else if($second == 'nhw')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
						  		...
						  		AND people.id=consumes.person
						  		AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are Non-Hispanic White: ';
					}
					else if($second == 'hispanic')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
								  ...
								  AND people.id=consumes.person
								  AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are Hispanic: ';
					}
					else if($second == 'nhb')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
								  ...
								  AND people.id=consumes.person
								  AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are Non-Hispanic Black: ';
					}
					else if($second == 'nhpi')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
					...
					else if($second == 'nhm')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
									...
									AND people.id=consumes.person
									AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are Non-Hispanic multiracial: ';
					}
					else if($second == 'nha')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
					...
					else if($second == 'nhna')
					{
						$s = "SELECT CAST(ROUND(((COUNT(*)*100)/9524),2) AS DECIMAL(5,2))
								  ...
								  AND people.id=consumes.person
								  AND consumes.drug='Marijuana'";
									$line = 'The percentage of people who use marijuana and are Non-Hispanic Native-American: ';
					}
				}
				else{
					if(!empty($S2) && empty($S3)){
						$line="The {$S1} {$S2} of Marijuana users: ";
					}
					else if(!empty($S2)){
						...
						$line="The {$S1} {$S2} of Marijuana users who work in the field of {$job} : ";
					}
					if($S1 == 'average')
					{
						if($S2 == 'age')
